...
out_dat <- out_dat[, c('plate', 'cell.line', 'treatment', 'chr', 'pos0', 'pos', 'rsID', 't.id', 'g.id', 'ensg', 'beta', 'beta.se', 'pval', 'qval', 'logFC')]
fileName <- paste0('./output/', plate, '_', cell.line, '_masterTable.txt')
